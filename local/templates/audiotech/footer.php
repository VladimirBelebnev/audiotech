    ...
    <div class="_container">
        <div class="footer__top footer__box">
            <div class="footer__col">
                <?php $APPLICATION->IncludeFile("/include/footer-phone.php", [], ["MODE" => "html"]); ?>
                <?php $APPLICATION->IncludeFile("/include/footer-mail.php", [], ["MODE" => "html"]); ?>
                <?php $APPLICATION->IncludeFile("/include/footer-address.php", [], ["MODE" => "html"]); ?>
        ...
        <div class="footer__bottom footer__box">
            <div class="footer__col footer__copy">
                <?php $APPLICATION->IncludeFile("/include/footer-rights.php", [], ["MODE" => "html"]); ?>
            </div>
            <?php $APPLICATION->IncludeFile("/include/footer-policy.php", [], ["MODE" => "html"]); ?>
            <?php $APPLICATION->IncludeFile("/include/footer-design.php", [], ["MODE" => "html"]); ?>
        </div>
    </div>
</footer>
...
<div class="modal-wrap" id="modalAccept">
    <div class="modal modal__accept"><img class="modal__accept-pic"
                                          src="<?php echo SITE_TEMPLATE_PATH ?>/images/check.svg" alt="">
