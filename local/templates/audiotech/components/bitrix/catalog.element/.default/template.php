        ...
        <div class="_container">
            <div class="product-title-wrap">
                ...
                <button class="btn btn--grey btn--m btn--icn btn-favorite product__btn-favorite <?php if ($arResult['IS_FAVORITE_ITEM'] == 'Y') echo 'active'; ?>"
                    ...
                    <span><?php echo $arResult['IS_FAVORITE_ITEM'] == 'Y' ? 'Добавлено в избранное' : 'Добавить в избранное'; ?></span>
                </button>
            </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php } else { ?>
                                    <div class="swiper-slide"><img
                                                src="<?php echo SITE_TEMPLATE_PATH; ?>/images/no-photo.png"
                                                alt="<?php echo $arResult['NAME']; ?>"></div>
                                <?php } ?>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php if ($arResult['PROPERTIES']['VIDEO']['VALUE']) { ?>
                                    <div class="swiper-slide swiper-slide__video">
                                        <div class="product__preview">
                                            <div class="play-video"><img
                                                        src="<?php echo $arResult['SLIDER'][0]['BIG']; ?>"
                                                        alt="<?php echo $arResult['NAME']; ?>">
                                                <button class="btn-play"></button>
                                            </div>
                                        </div>
                ...
                <div class="product__descr product-descr">
                    <div class="product-descr__price">
                        ...
                        <?php if ($arResult['PROPERTIES']['OLD_PRICE']['VALUE'] && $arResult['PROPERTIES']['OLD_PRICE']['VALUE'] > $arResult['ITEM_PRICES'][0]['PRICE']) { ?>
                            <div class="product-descr__old-price"><?php echo number_format($arResult['PROPERTIES']['OLD_PRICE']['VALUE'], 0, '', ' '); ?>
                                ₸
                            </div>
                        <?php } ?>
                    </div>
                            ...
                            <div class="cards-box">
                                <?php foreach ($arResult['ADD_ELEMENTS'] as $arItem) { ?>
                                    <div class="card">
                                        ...
                                        <a class="card__name"
                                           href="/catalog/<?php echo $arItem['DETAIL_PAGE_URL']; ?>"><?php echo $arItem['NAME']; ?></a>
                                        <div class="card__footer">
                                            <div class="card__price card__price--actual"><?php echo number_format($arItem['PRICE']['PRICE'], 0, '', ' '); ?>
                                                ₸
                                            </div>
                                            <?php if ($arItem['OLD_PRICE_VALUE'] && $arItem['OLD_PRICE_VALUE'] > $arItem['PRICE']['PRICE']) { ?>
                                                <div class="product-descr__old-price"><?php echo number_format($arItem['OLD_PRICE_VALUE'], 0, '', ' '); ?>
                                                    ₸
                                                </div>
                                            <?php } ?>
                                        </div>
                                        <button class="btn btn--red btn--icn btn--m"
                                                data-id="<?php echo $arItem['ID']; ?>" data-quantity="1">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path d="M17 9V8C17 5.2385 14.7615 3 12 3C9.2385 3 7 5.2385 7 8V9H4C3.44772 9 3 9.44772 3 10V18C3 19.6575 4.3425 21 6 21H18C19.6575 21 21 19.6575 21 18V10C21 9.44772 20.5523 9 20 9H17ZM9 8C9 6.34325 10.3433 5 12 5C13.6567 5 15 6.34325 15 8V9H9V8ZM19 18C19 18.5525 18.5525 19 18 19H6C5.4475 19 5 18.5525 5 18V11H19V18Z"
                                                      fill="white"/>
