...
<section class="product">
    <div class="_container">
        <div class="product-title-wrap">
            <h1 class="title-page product__title">
                <?php echo $arResult['NAME']; ?>
            </h1>
            <button class="btn btn--grey btn--m btn--icn btn-favorite product__btn-favorite">
                ...
                <!-- TODO функционал добавление в избранное -->
                <span>Добавить в избранное</span>
            </button>
        </div>
        <span class="product__article">Артикул: <?php echo $arResult['PROPERTIES']['CML2_ARTICLE']['VALUE']; ?></span>
        <div class="product__wrap">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <?php if($arResult['PROPERTIES']['VIDEO']['VALUE']) { ?>
                                <div class="swiper-slide swiper-slide__video"><img
                                            src="<?php echo $arResult['SLIDER'][0]['THUMB']['src']; ?>"
                                            alt="<?php echo $arResult['NAME']; ?>"></div>
                            <?php } ?>
                        </div>
                    </div>
                                    ...
                                    <div class="swiper-slide swiper-slide__video">
                                        <div class="product__preview">
                                            <div class="play-video"><img
                                                        src="<?php echo $arResult['SLIDER'][0]['MAIN']['src']; ?>"
                    ...
                    <div class="swiper-product" thumbsSlider>
                        <div class="swiper-wrapper">
                            ...
                            <?php if($arResult['PROPERTIES']['VIDEO']['VALUE']) { ?>
                                <div class="swiper-slide swiper-slide__video">
                                    <div class="product__preview">
                                        <div class="play-video"><img src="<?php echo $arResult['SLIDER'][0]['BIG']; ?>"
                                                                     alt="<?php echo $arResult['NAME']; ?>">
                                            <button class="btn-play"></button>
                                        </div>
                                    </div>
                ...
                <?php if($arResult['PROPERTIES']['VIDEO']['VALUE']) { ?>
                    <div class="video-wrap">
                        <iframe id="video" width="1024" height="768"
                                src="<?php echo $arResult['PROPERTIES']['VIDEO']['VALUE']; ?>"
            ...
            <div class="product__descr product-descr">
                <div class="product-descr__price">
                    <div class="product-descr__new-price"><?php echo $arResult['ITEM_PRICES'][0]['PRINT_BASE_PRICE']; ?>
                    ...
                    <?php if ($arResult['PROPERTIES']['OLD_PRICE']['VALUE'] && $arResult['PROPERTIES']['OLD_PRICE']['VALUE'] > $arResult['ITEM_PRICES'][0]['PRICE']) { ?>
                        <div class="product-descr__old-price"><?php echo number_format($arResult['PROPERTIES']['OLD_PRICE']['VALUE'], 0, '', ' '); ?> ₸</div>
                    <?php } ?>
                </div>
                <?php if ($arResult['PROPERTIES']['NOT_FOR_BUY']['VALUE'] == 'Y') { ?>
                    <div class="producr-descr__btns">
                        ...
                        <button class="btn btn--grey btn--l btn--icn btn--search">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="_container">
            <ul class="advantages__list">
                <li class="advantages__item">
                    ...
                    </div><?php $APPLICATION->IncludeFile("/include/service-item-1.php", [], ["MODE" => "html"]); ?>
                </li>
                <li class="advantages__item">
                    <div class="advantages__pic">
                ...
                <li class="advantages__item">
                    ...
                    </div><?php $APPLICATION->IncludeFile("/include/service-item-3.php", [], ["MODE" => "html"]); ?>
                </li>
                <li class="advantages__item">
                    <div class="advantages__pic">
                    ...
                    </div><?php $APPLICATION->IncludeFile("/include/service-item-4.php", [], ["MODE" => "html"]); ?>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="_container _container--mode">
        <div class="tabs">
            <div class="tabs__nav">
                ...
                <?php if ($arResult['PROPERTIES']['CML2_ATTRIBUTES']['VALUE'] || $arResult['PROPERTIES']['AUDIOGRAM']['VALUE']) { ?>
                    <button class="tabs__btn">Характеристики</button>
                <?php } ?>
                <?php if ($arResult['ADD_ELEMENTS']) { ?>
            ...
            <div class="tabs__content">
                <div class="tabs__pane show">
                    <div class="tabs__pane-wrap tabs__pane-wrap--product">
                        ...
                        <?php if($arResult['PROPERTIES']['AKUSTICHESKIE_SITUATSII']['VALUE']) { ?>
                            <div class="tabs__pane-box">
                                    ...
                                    <li class="tabs__pane-item">
                                        <div class="tabs__pane-item__pic">
                                            <?php if ($arResult['PROPERTIES']['AKUSTICHESKIE_SITUATSII']['VALUE'] == 'просмотр ТВ') { ?>
                                                        <div class="tabs__pane-item__pic"><img src="<?php echo SITE_TEMPLATE_PATH ?>/images/icns/md-tv.svg" alt="просмотр ТВ"></div>
                                            <?php } else if ($arResult['PROPERTIES']['AKUSTICHESKIE_SITUATSII']['VALUE'] == 'транспорт') { ?>
                                                <div class="tabs__pane-item__pic"><img src="<?php echo SITE_TEMPLATE_PATH ?>/images/icns/md-transport.svg" alt="транспорт"></div>
                                            <?php } else if ($arResult['PROPERTIES']['AKUSTICHESKIE_SITUATSII']['VALUE'] == 'музыка') { ?>
                                                <div class="tabs__pane-item__pic"><img src="<?php echo SITE_TEMPLATE_PATH ?>/images/icns/md-transport.svg" alt="музыка"></div>
                                            <?php } else { ?>
                                                 <img src="<?php echo SITE_TEMPLATE_PATH ?>/images/icns/md-relax.svg" alt="">
                                            <?php } ?>
                                        </div>
                ...
                <?php if ($arResult['PROPERTIES']['CML2_ATTRIBUTES']['VALUE'] || $arResult['PROPERTIES']['AUDIOGRAM']['VALUE']) { ?>
                    <div class="tabs__pane">
                        <div class="tabs__pane-wrap tabs__pane-wrap--product">
                            <div class="tabs__pane-box">
                                <?php if ($arResult['PROPERTIES']['CML2_ATTRIBUTES']['VALUE']) { ?>
                                ...
                                <div class="tabs__pane-box">
                                    ...
                                    <ul class="tabs__pane-list">
                                        ...
                                        <?php foreach ($arResult['FILES'] as $arFile) { ?>
                                            ...
                                            <li class="tabs__pane-item">
                                                <a class="tabs__pane-link" href="<?php echo $arFile['SRC']; ?>" download>
                                                    <div class="tabs__pane-item__pic tabs__pane-item__pic--mode">
                                                        <img src="<?php echo SITE_TEMPLATE_PATH ?>/images/icns/pdf.svg" alt=""></div>
                                                    <div>
                        ...
                        <div class="cards-box">
                            <?php foreach ($arResult['ADD_ELEMENTS'] as $arItem) { ?>
                                <div class="card">
                                    ...
                                    <a class="card__name" href="/catalog/<?php echo $arItem['DETAIL_PAGE_URL']; ?>"><?php echo $arItem['NAME']; ?></a>
                                    <div class="card__footer">
                                        <div class="card__price card__price--actual"><?php echo number_format($arItem['PRICE']['PRICE'], 0, '', ' '); ?> ₸</div>
                                        <?php if ($arItem['OLD_PRICE_VALUE'] && $arItem['OLD_PRICE_VALUE'] > $arItem['PRICE']['PRICE']) { ?>
                                            <div class="product-descr__old-price"><?php echo number_format($arItem['OLD_PRICE_VALUE'], 0, '', ' '); ?> ₸</div>
                                        <?php } ?>
                                    </div>
...
<?php $APPLICATION->IncludeComponent(
    'coderoom:similar.elements',
    '.default',
    [
        'SECTION_ID' => $arResult['SECTION']['PATH'][0]['ID'],
        'SECTION_PATH' => $arResult['SECTION']['PATH'][0]['SECTION_PAGE_URL'],
    ]
); ?>
