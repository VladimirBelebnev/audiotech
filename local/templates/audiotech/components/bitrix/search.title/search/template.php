...
<form id="<? echo $CONTAINER_ID ?>" class="header-top__item header-top__item-search" action="<? echo $arResult["FORM_ACTION"] ?>">
    <input id="search" type="text" placeholder="Поиск" name="q" value="">
