    ...
    <div class="_container">
        ...
        <div class="info-blocks__wrap">
            <?php foreach ($arResult['ITEMS'] as $arItem) { ?>
                <div class="info-block__item" style="background-image: url(<?php echo $arItem['PREVIEW_PICTURE']['SRC']; ?>)">
                    <div class="info-block__name"><?php echo $arItem['NAME']; ?></div>
                    <div class="info-block__descr"><?php echo $arItem['PREVIEW_TEXT']; ?></div>
                    <a class="btn btn--white btn--m info-block__link" href="<?php echo $arItem['DETAIL_PAGE_URL']; ?>">Перейти</a>
                </div>
            <?php } ?>
        </div>
    </div>
