...
<section class="news-page">
    <div class="_container">
        <div class="news-page__head">
            <h1 class="title-page news-page__title"> <span class="title-page__text">8 советов, чтобы лучше понять человека с потерей слуха</span></h1>
        ...
        <div class="__container-2cols">
            <div class="news-page__col news-page__content">
                <div class="news-page__block">
                    <div class="news-page__media"><img src="img/news1.jpg" alt=""></div>
                </div>
                <div class="news-page__block">
                    <div class="__container-s">
                        <h3>Praesent a imperdiet ante. Nulla vel odio ut dui tincidunt egestas. Duis sodales diam ligula, in commodo odio auctor non.</h3>
                    ...
                    <div class="swiper swiper-three-news pr30_m">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="card"> <a class="card__pic" href=""><img src="img/cards/pic1.jpg" alt=""></a><a class="card__category" href="">Слуховой аппарат</a><a class="card__name" href="">Audeo M30-R</a>
