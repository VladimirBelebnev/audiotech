    ...
    <div class="_container">
        <div class="news-page__head">
            <h1 class="title-page news-page__title">
				<span class="title-page__text"><?php echo $arResult["NAME"]; ?></span>
			</h1>
				...
				<?php if($arResult["DETAIL_PICTURE"]["SRC"]) {?>
					<div class="news-page__block">
						<div class="news-page__media">
							<img src="<?php echo $arResult["DETAIL_PICTURE"]["SRC"]; ?>" alt="<?php echo $arResult["NAME"]; ?>">
						</div>
					</div>
				<?php } ?>
