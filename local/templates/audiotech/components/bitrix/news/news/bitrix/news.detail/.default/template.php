        ...
        <div class="__container-2cols">
            <div class="news-page__col news-page__content">
                ...
                <div class="__container-s">
                    <div class="share">
                        <h4>Поделиться</h4>
                        <div class="share__social"><a class="share__item"
                                                      href="http://www.facebook.com/sharer.php?s=100&p[url]=<?php echo $_SERVER["SERVER_NAME"] . $arResult['DETAIL_PAGE_URL'] ?>">
                                ...
                                <span>Facebook</span></a><a class="share__item"
                                                            href="http://vkontakte.ru/share.php?url=<?php echo $_SERVER["SERVER_NAME"] . $arResult['DETAIL_PAGE_URL'] ?>">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
