...
<div class="wrapper">
    <?php if ($APPLICATION->GetCurPage(false) != '/personal/order/') { ?>
    <header class="header">
        ...
        <div class="header__bottom header-bottom">
            <div class="_container">
                <div class="header-bottom__box"><a class="header-bottom__logo" href="/"><img
                                src="<?php echo SITE_TEMPLATE_PATH ?>/images/athear-logo.svg" alt="auditech"></a>
                    <nav class="header-bottom__nav main-nav main-nav">
                        <div class="main-nav__actions main-nav-actions">
                            ...
                            <a class="main-nav-actions__item header-basket" href="/personal/cart/">
                                <span class="header-basket__count cart" <?php echo $countBasketItems == 0 ? 'style="display: none;"' : ''; ?>><?php echo $countBasketItems; ?></span>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="header-basket__count favorite" <?php echo $iFavoriteItem == 0 ? 'style="display: none;"' : ''; ?>><?php echo $iFavoriteItem; ?></span>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <div class="main-nav__submenu">
                                    <ul class="main-nav__submenu-box">
                                        ...
                                        <li class="main-nav__item main-nav__exit"><a class="main-nav__link"
                                                                                     href="/?logout=yes&<?php echo bitrix_sessid_get(); ?>">Выйти</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <?php if ($APPLICATION->GetCurPage(false) != '/' && strpos($APPLICATION->GetCurPage(false), '/customer/services/') === false && $APPLICATION->GetCurPage(false) != '/personal/order/') { ?>
        <?php $APPLICATION->IncludeComponent(
            'bitrix:breadcrumb',
            '.default',
            []
