            ...
            <div class="__inner">
                <div class="order__content">
                        ...
                        <div class="order__table table">
                            ...
                            <?php foreach ($arCartItems as $arItem) { ?>
                                <div class="table__row">
                                    <div class="table__item"><span>Товар</span><?php echo $arItem['NAME']; ?></div>
                    ...
                    <div class="order__block">
                        ...
                        <ul class="profile__list">
                            <?php $APPLICATION->IncludeComponent("bitrix:sale.location.selector.search", "order.location", array(
