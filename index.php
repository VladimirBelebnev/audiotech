...
//                        ?>
<!--                        <div class="swiper-slide">-->
<!--                            <div class="article-preview"><a class="article-preview__pic" href="--><?php //= $arItem["DETAIL_PAGE_URL"] ?><!--">-->
<!--                                    <img src="--><?php //= $arItem["PREVIEW_PICTURE"]["SRC"] ?><!--" alt="--><?// echo $arItem["NAME"] ?><!--"></a>-->
<!--                                --><?php
...
<!--                                <a class="article-preview__name" href="--><?php //= $arItem["DETAIL_PAGE_URL"] ?><!--">--><?// echo $arItem["NAME"] ?><!--</a>-->
